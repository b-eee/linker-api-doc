...
| 69 | [GetAutoNumber](api/items/GetAutoNumber.md#GetAutoNumber) | 自動採番 | POST | /api/v0/applications/:project-id/datastores/:datastore-id/fields/:field-id/autonum | アイテム登録用の番号を採番する | v0 | - |
